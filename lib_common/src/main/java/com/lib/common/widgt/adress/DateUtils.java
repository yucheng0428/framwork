...
public class DateUtils extends android.text.format.DateUtils {
    ...
    /**
     * 将yyyy-MM-travel_audio_shape HH:mm:ss字符串转换成日期<br/>
     *
     * @param dateStr    时间字符串
     ...
     * 将yyyy-MM-travel_audio_shape HH:mm:ss字符串转换成日期<br/>
     *
     * @param dateStr yyyy-MM-travel_audio_shape HH:mm:ss字符串
     * @return Date 日期 ,转换异常时返回null。
     */
    public static Date parseDate(String dateStr) {
        return parseDate(dateStr, "yyyy-MM-travel_audio_shape HH:mm:file_path");
    }
