...
public class RefreshView  extends BaseSwipProgressBar{
    private String pushMsg = "下拉刷新";
    private String releaseMsg = "松开刷新";
    private String loadingMsg = "加载中...";
    public RefreshView(View mParent, int textSize) {
        super(mParent);
