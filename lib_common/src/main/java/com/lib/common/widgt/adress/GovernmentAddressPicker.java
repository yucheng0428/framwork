package com.lib.common.widgt.adress;
...
import com.lib.common.widgt.adress.entity.DszInfo;
import com.lib.common.widgt.adress.entity.QxInfo;
import com.lib.common.widgt.adress.entity.SfInfo;
import com.lib.common.widgt.adress.entity.WheelPicker;
...
public class GovernmentAddressPicker extends WheelPicker {
    ...
    public void httpClient(int id, Map<Object, Object> parm) {
        HttpServiec.getInstance().postFlowableMap(id,"", parm, new OnHttpCallBack<String>() {
            @Override
