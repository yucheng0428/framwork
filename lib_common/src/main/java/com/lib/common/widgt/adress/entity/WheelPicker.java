package com.lib.common.widgt.adress.entity;
...
import com.lib.common.widgt.adress.WheelView;
import com.lib.common.widgt.adress.popup.ConfirmPopup;
...
public abstract class WheelPicker extends ConfirmPopup<View> {
     ...
     */
    public void setLineConfig( WheelView.LineConfig config) {
        if (null == config) {
            lineConfig = new WheelView.LineConfig();
