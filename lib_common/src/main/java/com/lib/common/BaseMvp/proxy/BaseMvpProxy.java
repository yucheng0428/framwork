package com.lib.common.BaseMvp.proxy;
...
public class BaseMvpProxy <V extends BaseView, P extends BasePresenter<V>> implements PresenterProxyInterface<V, P> {
    ...
    public P getMvpPresenter() {
        Log.d("perfect-mvp","Proxy getMvpPresenter");
        if (mFactory != null) {
            if (mPresenter == null) {
        ...
        Log.d("perfect-mvp","Proxy getMvpPresenter = " + mPresenter);
        return mPresenter;
    }
    ...
    public void onResume(V mvpView) {
        getMvpPresenter();
        Log.d("perfect-mvp","Proxy onResume");
    ...
    private void onDetachMvpView() {
        Log.d("perfect-mvp","Proxy onDetachMvpView = ");
        if (mPresenter != null && mIsAttchView) {
    ...
    public void onDestroy() {
        Log.d("perfect-mvp","Proxy onDestroy = ");
        if (mPresenter != null ) {
            onDetachMvpView();
    ...
    public Bundle onSaveInstanceState() {
        Log.d("perfect-mvp","Proxy onSaveInstanceState = ");
    ...
    public void onRestoreInstanceState(Bundle savedInstanceState) {
        Log.d("perfect-mvp","Proxy onRestoreInstanceState = ");
        Log.d("perfect-mvp","Proxy onRestoreInstanceState Presenter = " + mPresenter);
