...
import com.qyai.navimap.PoiOverlay;
import com.qyai.navimap.R;
import com.qyai.navimap.R2;
...
public class SelectLoctionActivity extends BaseHeadActivity implements AMapLocationListener,
    ...
    protected void initUIData() {
        setTvTitle("地图选点");
        PermissionCheckUtils.requestPermissions(SelectLoctionActivity.this, Common.REQUEST_CODE, Common.permissionList1); // 动态请求权限
        Common.openGPSSEtting(SelectLoctionActivity.this);
        if (aMap == null) {
